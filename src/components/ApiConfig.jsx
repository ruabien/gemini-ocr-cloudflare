        ...
        <div className="flex flex-1 flex-col sm:flex-row items-center gap-3 w-full lg:justify-end">
          ...
          <div className="flex w-full sm:w-auto gap-2">
            <div className="relative flex-1 sm:w-48 group">
              ...
              <select
                ...
                className="w-full pl-9 pr-8 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all font-medium text-slate-700 appearance-none cursor-pointer"
              >
            ...
            <button
              ...
              className="px-3 py-2 bg-indigo-50 text-indigo-600 rounded-xl hover:bg-indigo-100 transition-colors border border-indigo-200 flex items-center justify-center disabled:opacity-50 cursor-pointer"
          ...
          {model === 'Khác' && (
            <input
              ...
              className="w-full sm:w-48 px-3 py-2 bg-amber-50 border border-amber-200 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 transition-all font-medium text-amber-900 placeholder-amber-400"
            />
          )}
