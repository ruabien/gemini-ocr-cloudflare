...
>
  ...
  <span>Cài đặt</span>
        ...
        {/* Section tài khoản OAuth & Hamburger */}
        <div className="flex items-center space-x-2 md:space-x-3" ref={mobileMenuRef}>
          {/* Section tài khoản OAuth (Desktop) */}
          <div className="relative" ref={dropdownRef}>
            {user ? (
              ...
              <button
                onClick={handleLogin}
                className="bg-red-600 hover:bg-red-700 text-white px-2.5 py-1.5 md:px-3.5 rounded-lg text-xs font-bold tracking-wide flex items-center space-x-1 md:space-x-2 border border-red-500/50 shadow-md transition-all cursor-pointer"
              >
          ...
          <button
            ...
            className="md:hidden p-2 rounded-lg text-slate-350 hover:bg-slate-800 hover:text-white transition-colors cursor-pointer"
            aria-label="Mở menu"
          >
