...
import { onRequestPost as __api_usage_check_ts_onRequestPost } from "D:\\Tools\\gemini-ocr-cloudflare\\functions\\api\\usage\\check.ts"
import { onRequest as __api_usage_commit_ts_onRequest } from "D:\\Tools\\gemini-ocr-cloudflare\\functions\\api\\usage\\commit.ts"
...
import { onRequest as __knowledge___slug___ts_onRequest } from "D:\\Tools\\gemini-ocr-cloudflare\\functions\\knowledge\\[[slug]].ts"
...
export const routes = [
  ...
  {
      routePath: "/api/usage/check",
      mountPath: "/api/usage",
      method: "POST",
      middlewares: [],
      modules: [__api_usage_check_ts_onRequestPost],
    },
  {
      routePath: "/api/usage/commit",
      mountPath: "/api/usage",
      method: "",
      middlewares: [],
      modules: [__api_usage_commit_ts_onRequest],
    },
  {
    ...
    },
  {
      ...
      method: "",
      middlewares: [],
      modules: [__knowledge___slug___ts_onRequest],
    },
  {
